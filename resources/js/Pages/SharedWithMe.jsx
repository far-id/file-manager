...
function SharedWithMe({ files }) {
    ...
    const openFolder = (file) => {
        ...
        router.visit(route('file.sharedWithMe', { folder: file.ulid }));
    };
                    ...
                    <nav className="flex" aria-label="Breadcrumb">
                        <ol className="inline-flex items-center space-x-1 md:space-x-3">
                            <li className="inline-flex items-center">
                                <Link href={ route('file.sharedWithMe') } className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
...
SharedWithMe.layout = (page) => <AuthLayout children={ page } />;
